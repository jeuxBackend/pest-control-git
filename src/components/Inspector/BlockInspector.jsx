...
function BlockInspector() {
  ...
  const filteredUsers = BlockInspectors.filter((item) => {
    ...
    return (
      item.user_name?.toLowerCase().includes(lowerCaseSearchTerm) ||
    ...
    <div className="w-full h-full min-h-screen bg-[#fafafa]">
      ...
      <div className="BlockInspectorss-div relative  lg:ml-[260px] px-3 top-[20px]">
        <div className="users-nav w-full flex flex-wrap justify-between">
          {/* <div className="active-block-brns xl:w-[40%] lg:w-[100%] mt-2">
            <div>
              <button
                ...
                className={`w-[120px] h-[50px] flex justify-center gap-2 items-center border  text-lg font-semibold shadow-sm rounded ${
          ...
          <div className="user-add-search-div xl:w-[100%] lg:w-[100%] mt-2">
            <div className="flex flex-wrap justify-between gap-2">
              <button
                onClick={() => setOpenAddInspector(true)}
                className={`w-[180px] h-[50px] flex justify-center gap-2 items-center bg-[#003a5f] text-white text-[15px] font-semibold shadow-sm rounded ${
          ...
          <div className="active-block-brns lg:w-[100%] mt-4">
            <ul className="flex flex-wrap gap-2">
              ...
              <li>
                <Link to={"/DeleteTechnician"}>
                  <button
                    onClick={() => setPageHeading("Deleted Technicians")}
                    className={`w-[120px] h-[50px] flex justify-center gap-2 items-center border  text-lg font-semibold shadow-sm rounded ${
                      delTechnician
                  ...
                  {currentUsers.map((data, index) => {
                    return (
                      <tr key={index} className="">
                        ...
                        <td
                          className={`py-3 px-5 border-b border-r ${
                            delTechnician ? "hidden" : ""
                          }`}
                        >
                        ...
                        <td
                          className={`py-3 border-b border-r ${
