  ...
  useEffect(() => {
    if (inspectorData) {
      ...
      if (inspectorData.inspector) {
        setPhone(inspectorData.inspector.number ? inspectorData.inspector.number : "");
        setLicenseDate(inspectorData.inspector.license_date ? inspectorData.inspector.license_date : "");
        setExpireDate(inspectorData.inspector.expire_date ? inspectorData.inspector.expire_date : "");
      } else {
        setPhone("");
        setLicenseDate("");
        setExpireDate("");
      ...
      setPassword(inspectorData.show_password ? inspectorData.show_password : "" );
      setProfile(inspectorData.profile_pic ? inspectorData.profile_pic : "");
      setImageVoucher(inspectorData.profile_pic ? inspectorData.profile_pic : "");
    }
  }, [inspectorData]);
